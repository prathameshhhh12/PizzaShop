                    ...
                    <center>
                        ...
                        <table border="1" width="30%" cellpadding="3" float="right"; position="relative"; top="30%" >
                            <tbody style="top:10%;position:absolute;float:right;width:300px;height:300px;">
                                ...
                                <tr>
                                    <td colspan="2"><a href="register.jsp"><h1 style="font-size:17px">Create an account</h1></a></td>
                                </tr>
                                <tr>
                                    <td colspan="2"><a href="forget.jsp"><h1 style="font-size:17px">Forgot Password</h1></a></td>
                                </tr>
                                 <tr>
                                    <td colspan="2"><a href="admin.jsp"><h1 style="font-size:17px">Login as Admin</h1></a></td>
                                </tr>
                            </tbody>
                        </table>
                            <tbody >
